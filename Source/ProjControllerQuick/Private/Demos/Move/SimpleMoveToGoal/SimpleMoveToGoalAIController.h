...
#include "SimpleMoveToGoalAIController.generated.h"

/**
* Controller for quick tests
*/

/** ETestSimpleMoveToGoalMode*/
UENUM(BlueprintType, Category=Misc)
enum class ETestSimpleMoveToGoalMode : uint8
{
	/** RequestMove*/
...
UCLASS()
class ASimpleMoveToGoalAIController : public AMyAIControllerBase
{
	GENERATED_BODY()

public:
	ASimpleMoveToGoalAIController();
...
private:
	...
	ETestSimpleMoveToGoalMode MoveToGoalMode = ETestSimpleMoveToGoalMode::RequestMove;  
